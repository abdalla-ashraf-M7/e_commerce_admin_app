...
class CustomTextFormGlobal extends StatelessWidget {
  const CustomTextFormGlobal({super.key, required this.hint, required this.label, this.icon, this.textformcontroller, this.valid, this.isnumber, this.isobscure, this.ontapicon, this.isreadonly});
  final String hint;
  final String label;
  final IconData? icon;
  final bool? isnumber;
